...
;* Date/Time created: Tue Sep 27 14:08:27 2016                                *
;******************************************************************************
...
$C$DW$CU	.dwtag  DW_TAG_compile_unit
	.dwattr $C$DW$CU, DW_AT_name("../Drivers/UARTStdio_Initialization.c")
...
$C$DW$6	.dwtag  DW_TAG_subprogram
	...
	.dwattr $C$DW$6, DW_AT_decl_file("H:/EECS_388/TI_ARM_Projects/Program_ButtonPush/Drivers/uartstdio.h")
...
$C$DW$8	.dwtag  DW_TAG_variable
	...
	.dwattr $C$DW$8, DW_AT_decl_file("../Drivers/UARTStdio_Initialization.c")
	.dwattr $C$DW$8, DW_AT_decl_line(0x1f)
	.dwattr $C$DW$8, DW_AT_decl_column(0x29)

;	C:\TI_CodeComposer\ccsv6\tools\compiler\ti-cgt-arm_15.12.1.LTS\bin\armacpia.exe -@C:\\Users\\alinvill\\AppData\\Local\\Temp\\0461212 
	.sect	".text"
	.clink
...
$C$DW$9	.dwtag  DW_TAG_subprogram
	...
	.dwattr $C$DW$9, DW_AT_TI_begin_file("../Drivers/UARTStdio_Initialization.c")
	.dwattr $C$DW$9, DW_AT_TI_begin_line(0x28)
	.dwattr $C$DW$9, DW_AT_TI_begin_column(0x11)
	.dwattr $C$DW$9, DW_AT_decl_file("../Drivers/UARTStdio_Initialization.c")
	.dwattr $C$DW$9, DW_AT_decl_line(0x28)
	.dwattr $C$DW$9, DW_AT_decl_column(0x11)
	.dwattr $C$DW$9, DW_AT_TI_max_frame_size(0x08)
	.dwpsn	file "../Drivers/UARTStdio_Initialization.c",line 40,column 44,is_stmt,address UARTStdio_Initialization,isa 1
...
;* --------------------------------------------------------------------------*
	...
	.dwpsn	file "../Drivers/UARTStdio_Initialization.c",line 42,column 9,is_stmt,isa 1
        LDR       A1, $C$CON1           ; [DPU_3_PIPE] |42| 
        LDR       A1, [A1, #0]          ; [DPU_3_PIPE] |42| 
        CBNZ      A1, ||$C$L1||         ; [] 
        ; BRANCHCC OCCURS {||$C$L1||}    ; [] |42| 
;* --------------------------------------------------------------------------*
	.dwpsn	file "../Drivers/UARTStdio_Initialization.c",line 52,column 13,is_stmt,isa 1
...
$C$DW$10	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$10, DW_AT_TI_call
        ...
        BL        SysCtlPeripheralEnable ; [DPU_3_PIPE] |52| 
        ; CALL OCCURS {SysCtlPeripheralEnable }  ; [] |52| 
	.dwpsn	file "../Drivers/UARTStdio_Initialization.c",line 53,column 13,is_stmt,isa 1
...
$C$DW$11	.dwtag  DW_TAG_TI_branch
	...
	.dwpsn	file "../Drivers/UARTStdio_Initialization.c",line 54,column 13,is_stmt,isa 1
...
$C$DW$12	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$12, DW_AT_TI_call
        ...
        BL        GPIOPinTypeUART       ; [DPU_3_PIPE] |54| 
        ; CALL OCCURS {GPIOPinTypeUART }  ; [] |54| 
	.dwpsn	file "../Drivers/UARTStdio_Initialization.c",line 59,column 13,is_stmt,isa 1
...
$C$DW$13	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$13, DW_AT_TI_call
        ...
        BL        UARTStdioInit         ; [DPU_3_PIPE] |59| 
        ; CALL OCCURS {UARTStdioInit }   ; [] |59| 
	.dwpsn	file "../Drivers/UARTStdio_Initialization.c",line 61,column 13,is_stmt,isa 1
        LDR       A2, $C$CON1           ; [DPU_3_PIPE] |61| 
        MOVS      A1, #1                ; [DPU_3_PIPE] |61| 
        STR       A1, [A2, #0]          ; [DPU_3_PIPE] |61| 
;* --------------------------------------------------------------------------*
||$C$L1||:    
	.dwpsn	file "../Drivers/UARTStdio_Initialization.c",line 64,column 5,is_stmt,isa 1
        MOVS      A1, #1                ; [DPU_3_PIPE] |64| 
	.dwpsn	file "../Drivers/UARTStdio_Initialization.c",line 66,column 2,is_stmt,isa 1
$C$DW$14	.dwtag  DW_TAG_TI_branch
	...
	.dwcfi	cfa_offset, 0
        ; BRANCH OCCURS                  ; [] 
	.dwattr $C$DW$9, DW_AT_TI_end_file("../Drivers/UARTStdio_Initialization.c")
