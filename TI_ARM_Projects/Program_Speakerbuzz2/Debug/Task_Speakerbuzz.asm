...
;* Date/Time created: Wed Sep 14 14:35:13 2016                                *
;******************************************************************************
...
$C$DW$22	.dwtag  DW_TAG_variable
	...
	.bss	Task_ToneChange_DeltaExecute,4,4
$C$DW$23	.dwtag  DW_TAG_variable
	.dwattr $C$DW$23, DW_AT_name("Task_ToneChange_DeltaExecute")
	.dwattr $C$DW$23, DW_AT_TI_symbol_name("Task_ToneChange_DeltaExecute")
	.dwattr $C$DW$23, DW_AT_type(*$C$DW$T$47)
	.dwattr $C$DW$23, DW_AT_location[DW_OP_addr Task_ToneChange_DeltaExecute]
...
;	C:\TI_CodeComposer\ccsv6\tools\compiler\ti-cgt-arm_15.12.1.LTS\bin\armacpia.exe -@C:\\Users\\alinvill\\AppData\\Local\\Temp\\2219612 
	.sect	".text"
	.clink
...
$C$DW$24	.dwtag  DW_TAG_subprogram
	...
	.dwattr $C$DW$24, DW_AT_TI_begin_line(0x1f)
	...
	.dwpsn	file "../Tasks/Task_Speakerbuzz.c",line 31,column 32,is_stmt,address Task_Speakerbuzz,isa 1
...
$C$DW$25	.dwtag  DW_TAG_variable
	...
	.dwpsn	file "../Tasks/Task_Speakerbuzz.c",line 32,column 23,is_stmt,isa 1
        MOVS      A1, #0                ; [DPU_3_PIPE] |32| 
        STR       A1, [SP, #0]          ; [DPU_3_PIPE] |32| 
	.dwpsn	file "../Tasks/Task_Speakerbuzz.c",line 34,column 2,is_stmt,isa 1
        LDR       A1, $C$CON1           ; [DPU_3_PIPE] |34| 
        LDRB      A1, [A1, #0]          ; [DPU_3_PIPE] |34| 
        CBNZ      A1, ||$C$L1||         ; [] 
        ; BRANCHCC OCCURS {||$C$L1||}    ; [] |34| 
;* --------------------------------------------------------------------------*
	.dwpsn	file "../Tasks/Task_Speakerbuzz.c",line 36,column 3,is_stmt,isa 1
...
$C$DW$26	.dwtag  DW_TAG_TI_branch
	...
	.dwpsn	file "../Tasks/Task_Speakerbuzz.c",line 39,column 3,is_stmt,isa 1
        LDR       A1, $C$CON3           ; [DPU_3_PIPE] |39| 
        MOVS      A2, #3                ; [DPU_3_PIPE] |39| 
$C$DW$27	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$27, DW_AT_low_pc(0x00)
	.dwattr $C$DW$27, DW_AT_name("GPIOPinTypeGPIOOutput")
	.dwattr $C$DW$27, DW_AT_TI_call

        BL        GPIOPinTypeGPIOOutput ; [DPU_3_PIPE] |39| 
        ; CALL OCCURS {GPIOPinTypeGPIOOutput }  ; [] |39| 
	.dwpsn	file "../Tasks/Task_Speakerbuzz.c",line 40,column 3,is_stmt,isa 1
        LDR       A1, $C$CON3           ; [DPU_3_PIPE] |40| 
        MOVS      A2, #3                ; [DPU_3_PIPE] |40| 
        MOVS      A3, #1                ; [DPU_3_PIPE] |40| 
        MOVS      A4, #8                ; [DPU_3_PIPE] |40| 
$C$DW$28	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$28, DW_AT_low_pc(0x00)
	.dwattr $C$DW$28, DW_AT_name("GPIOPadConfigSet")
	.dwattr $C$DW$28, DW_AT_TI_call

        BL        GPIOPadConfigSet      ; [DPU_3_PIPE] |40| 
        ; CALL OCCURS {GPIOPadConfigSet }  ; [] |40| 
	.dwpsn	file "../Tasks/Task_Speakerbuzz.c",line 43,column 3,is_stmt,isa 1
        LDR       A1, $C$CON3           ; [DPU_3_PIPE] |43| 
        MOVS      A2, #3                ; [DPU_3_PIPE] |43| 
        MOVS      A3, #1                ; [DPU_3_PIPE] |43| 
$C$DW$29	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$29, DW_AT_low_pc(0x00)
	.dwattr $C$DW$29, DW_AT_name("GPIOPinWrite")
	.dwattr $C$DW$29, DW_AT_TI_call

        BL        GPIOPinWrite          ; [DPU_3_PIPE] |43| 
        ; CALL OCCURS {GPIOPinWrite }    ; [] |43| 
	.dwpsn	file "../Tasks/Task_Speakerbuzz.c",line 45,column 3,is_stmt,isa 1
        LDR       A1, $C$CON5           ; [DPU_3_PIPE] |45| 
        LDR       A2, $C$CON4           ; [DPU_3_PIPE] |45| 
        LDR       A1, [A1, #0]          ; [DPU_3_PIPE] |45| 
        MOV       A3, #1666             ; [DPU_3_PIPE] |45| 
        UDIV      A1, A1, A3            ; [DPU_3_PIPE] |45| 
        STR       A1, [A2, #0]          ; [DPU_3_PIPE] |45| 
	.dwpsn	file "../Tasks/Task_Speakerbuzz.c",line 46,column 3,is_stmt,isa 1
        LDR       A1, $C$CON5           ; [DPU_3_PIPE] |46| 
        LDR       A2, $C$CON6           ; [DPU_3_PIPE] |46| 
        LDR       A1, [A1, #0]          ; [DPU_3_PIPE] |46| 
        MOV       A3, #1666             ; [DPU_3_PIPE] |46| 
        UDIV      A1, A1, A3            ; [DPU_3_PIPE] |46| 
        STR       A1, [A2, #0]          ; [DPU_3_PIPE] |46| 
	.dwpsn	file "../Tasks/Task_Speakerbuzz.c",line 47,column 3,is_stmt,isa 1
        LDR       A2, $C$CON8           ; [DPU_3_PIPE] |47| 
...
;* --------------------------------------------------------------------------*
||$C$L1||:    
	.dwpsn	file "../Tasks/Task_Speakerbuzz.c",line 53,column 2,is_stmt,isa 1
        LDR       A1, $C$CON7           ; [DPU_3_PIPE] |53| 
        LDR       A2, $C$CON8           ; [DPU_3_PIPE] |53| 
...
;* --------------------------------------------------------------------------*
	.dwpsn	file "../Tasks/Task_Speakerbuzz.c",line 55,column 9,is_stmt,isa 1
...
$C$DW$30	.dwtag  DW_TAG_TI_branch
	...
	.dwpsn	file "../Tasks/Task_Speakerbuzz.c",line 58,column 9,is_stmt,isa 1
        LDR       A1, [SP, #0]          ; [DPU_3_PIPE] |58| 
        EOR       A1, A1, #3            ; [DPU_3_PIPE] |58| 
        STR       A1, [SP, #0]          ; [DPU_3_PIPE] |58| 
	.dwpsn	file "../Tasks/Task_Speakerbuzz.c",line 61,column 9,is_stmt,isa 1
...
$C$DW$31	.dwtag  DW_TAG_TI_branch
	...
	.dwpsn	file "../Tasks/Task_Speakerbuzz.c",line 65,column 9,is_stmt,isa 1
        LDR       A2, $C$CON8           ; [DPU_3_PIPE] |65| 
        LDR       A1, $C$CON4           ; [DPU_3_PIPE] |65| 
        LDR       A3, [A2, #0]          ; [DPU_3_PIPE] |65| 
        LDR       A1, [A1, #0]          ; [DPU_3_PIPE] |65| 
        LDR       A2, $C$CON7           ; [DPU_3_PIPE] |65| 
        ADDS      A1, A1, A3            ; [DPU_3_PIPE] |65| 
        STR       A1, [A2, #0]          ; [DPU_3_PIPE] |65| 
;* --------------------------------------------------------------------------*
||$C$L2||:    
	.dwpsn	file "../Tasks/Task_Speakerbuzz.c",line 69,column 2,is_stmt,isa 1
        LDR       A1, $C$CON6           ; [DPU_3_PIPE] |69| 
        LDR       A2, $C$CON8           ; [DPU_3_PIPE] |69| 
        LDR       A1, [A1, #0]          ; [DPU_3_PIPE] |69| 
        LDR       A2, [A2, #0]          ; [DPU_3_PIPE] |69| 
        CMP       A1, A2                ; [DPU_3_PIPE] |69| 
        BHI       ||$C$L5||             ; [DPU_3_PIPE] |69| 
        ; BRANCHCC OCCURS {||$C$L5||}    ; [] |69| 
;* --------------------------------------------------------------------------*
	.dwpsn	file "../Tasks/Task_Speakerbuzz.c",line 70,column 3,is_stmt,isa 1
        LDR       A1, $C$CON5           ; [DPU_3_PIPE] |70| 
        LDR       A2, $C$CON4           ; [DPU_3_PIPE] |70| 
        LDR       A1, [A1, #0]          ; [DPU_3_PIPE] |70| 
        LDR       A2, [A2, #0]          ; [DPU_3_PIPE] |70| 
        MOV       A3, #1666             ; [DPU_3_PIPE] |70| 
        UDIV      A1, A1, A3            ; [DPU_3_PIPE] |70| 
        CMP       A1, A2                ; [DPU_3_PIPE] |70| 
        BNE       ||$C$L3||             ; [DPU_3_PIPE] |70| 
        ; BRANCHCC OCCURS {||$C$L3||}    ; [] |70| 
;* --------------------------------------------------------------------------*
	.dwpsn	file "../Tasks/Task_Speakerbuzz.c",line 71,column 4,is_stmt,isa 1
        LDR       A1, $C$CON5           ; [DPU_3_PIPE] |71| 
        LDR       A2, $C$CON4           ; [DPU_3_PIPE] |71| 
        LDR       A1, [A1, #0]          ; [DPU_3_PIPE] |71| 
        MOV       A3, #888              ; [DPU_3_PIPE] |71| 
        UDIV      A1, A1, A3            ; [DPU_3_PIPE] |71| 
        STR       A1, [A2, #0]          ; [DPU_3_PIPE] |71| 
	.dwpsn	file "../Tasks/Task_Speakerbuzz.c",line 72,column 3,is_stmt,isa 1
        B         ||$C$L4||             ; [DPU_3_PIPE] |72| 
        ; BRANCH OCCURS {||$C$L4||}      ; [] |72| 
;* --------------------------------------------------------------------------*
||$C$L3||:    
	.dwpsn	file "../Tasks/Task_Speakerbuzz.c",line 73,column 4,is_stmt,isa 1
        LDR       A1, $C$CON5           ; [DPU_3_PIPE] |73| 
        LDR       A2, $C$CON4           ; [DPU_3_PIPE] |73| 
        LDR       A1, [A1, #0]          ; [DPU_3_PIPE] |73| 
        MOV       A3, #1666             ; [DPU_3_PIPE] |73| 
        UDIV      A1, A1, A3            ; [DPU_3_PIPE] |73| 
        STR       A1, [A2, #0]          ; [DPU_3_PIPE] |73| 
;* --------------------------------------------------------------------------*
||$C$L4||:    
	.dwpsn	file "../Tasks/Task_Speakerbuzz.c",line 76,column 3,is_stmt,isa 1
        LDR       A1, $C$CON8           ; [DPU_3_PIPE] |76| 
        LDR       A2, $C$CON6           ; [DPU_3_PIPE] |76| 
        LDR       A3, [A1, #0]          ; [DPU_3_PIPE] |76| 
        MOV       A1, #7500             ; [DPU_3_PIPE] |76| 
        ADDS      A1, A1, A3            ; [DPU_3_PIPE] |76| 
        STR       A1, [A2, #0]          ; [DPU_3_PIPE] |76| 
	.dwpsn	file "../Tasks/Task_Speakerbuzz.c",line 79,column 1,is_stmt,isa 1
;* --------------------------------------------------------------------------*
||$C$L5||:    
...
||$C$CON5||:	.bits	SysTickFrequency_Nbr,32
	.align	4
||$C$CON6||:	.bits	Task_ToneChange_DeltaExecute,32
	.align	4
||$C$CON7||:	.bits	Task_SpeakerBuzz_NextExecute,32
	.align	4
||$C$CON8||:	.bits	SysTickCount_Nbr,32
;*****************************************************************************
