...
//***GJM -- Corrected register name from: portNVIC_SYSPRI2_REG to: portNVIC_SYSPRI3_REG
#define portNVIC_SYSPRI3_REG				( * ( ( volatile unsigned long * ) 0xe000ed20 ) )
...
variable. */
static portBASE_TYPE uxCriticalNesting = 0xaaaaaaaa;
